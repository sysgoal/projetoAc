...
$this->title = 'Atualizar avaliação de coluna: ' . $model->aluno->nm_aluno;
$this->params['breadcrumbs'][] = ['label' => 'Avaliação Coluna', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->aluno->nm_aluno, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = 'Atualizar';
?>
<div class="avaliacao-coluna-update">
