...
<?= $form->field($model, 'ds_disfuncao_avds')->textarea(['style' => 'width:500px', 'rows' => 5, 'id' =>'avd']) ?>
    ...
    <?= $form->field($model, 'ds_dor')->textarea(['style' => 'width:500px','rows' => 5, 'id'=>'dor']) ?>
        ...
        <div class="col-md-6">   
            <br>
    <?= $form->field($model, 'ds_localizacao')->textInput(['style' => 'width:500px', 'id'=>'localizacao']) ?>
        </div>
    </div>
        <div class="row">
        <div class="col-md-6">                  
...
<div class="row">
        ...
        <div class="col-md-6">       
            ...
            <?= $form->field($model, 'ds_cirurgia_internacao')->textInput(['id' => 'dscirurgia', 'style' => 'width:500px'])->label(false) ?>
        </div>
</div>   
...
<div class="row">
        <div class="col-md-6">   
              ...
              <?= $form->field($model, 'ds_fisioterapia_quando')->textInput(['id' => 'dsfisioterapia', 'style' => 'width:500px'])->label(false) ?>            
        </div>
        <div class="col-md-6">   
        </div>
</div>
