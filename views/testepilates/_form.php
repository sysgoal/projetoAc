...
<div class="teste-pilates-form">
    ...
    <div class="row">       
        <div class="col-md-4">
            <?= $form->field($model, 'ds_001')->textInput(['style' => 'width:250px']) ?>
        </div>
        <div class="col-md-4">
            <?= $form->field($model, 'ds_002')->textInput(['style' => 'width:250px']) ?>
        </div>
    </div>
    <div class="row">       
        <div class="col-md-4">
            <?= $form->field($model, 'ds_003')->textInput(['style' => 'width:250px']) ?>
        </div>
        <div class="col-md-4">
            <?= $form->field($model, 'ds_004')->textInput(['style' => 'width:250px']) ?>
        </div>
    </div>
    <div class="row">       
        <div class="col-md-4">
            <?= $form->field($model, 'ds_005')->textInput(['style' => 'width:250px']) ?>
        </div>
    </div>
    <div class="row">       
        <div class="col-md-4">
