...
<div class="avaliacao-form">    
    ...
    <div class="row">
        ...
        <div class="col-md-6">      
            <?= $form->field($model, 'ds_comentario_tabagismo', ['options' => ['style' => 'width:500px', 'id' => 'comentario1']])->textarea(['rows' => 5, 'id'=>'dstabagismo']) ?>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <br>
            <?= $form->field($model, 'ds_doenca_respiratoria')->textarea(['rows' => 5, 'id'=>'respira']) ?>        
        </div>
