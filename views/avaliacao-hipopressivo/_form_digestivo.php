...
<div class="avaliacao-form">    
    ...
    <div class="row">
         ...
         <div class="col-md-6">
          <?= $form->field($model, 'ds_acool', ['options' => ['id' => 'alco']])->textInput(['style' => 'width:500px',  'id' =>'consumoAlcool']) ?>

        </div>      
    </div>
    <div class="row">
        <div class="col-md-6">  
        <?= $form->field($model, 'ds_comentario_disgestivo')->textarea(['rows' => 5,'style' => 'width:500px', 'id'=>'digestivo']) ?>
        </div></div>
</div>
    <br>
